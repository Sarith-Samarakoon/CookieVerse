...
const UpdateLearningPlan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const toastId = toast.loading("Updating your learning plan...");
    ...
    try {
      ...
      if (response.status === 200) {
        toast.update(toastId, {
          render: "Learning plan updated successfully!",
          type: "success",
          isLoading: false,
          autoClose: 3000,
        });
      ...
      const errorMessage =
        error.response?.status === 404
          ? "Learning plan not found. It may have been deleted."
          : "There was an error updating your learning plan.";
